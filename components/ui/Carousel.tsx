      ...
      {showArrows && count > 1 && (
        <>
          <button
            ...
            className="absolute left-0 top-1/2 hidden -translate-y-1/2 rounded-full border border-charcoal/10 bg-white p-2 shadow-md transition hover:bg-[#F5EDE0] disabled:opacity-50 disabled:hover:bg-white sm:flex"
          >
            <ChevronLeft size={20} />
          </button>
          <button
            ...
            className="absolute right-0 top-1/2 hidden -translate-y-1/2 rounded-full border border-charcoal/10 bg-white p-2 shadow-md transition hover:bg-[#F5EDE0] disabled:opacity-50 disabled:hover:bg-white sm:flex"
          >
        ...
        <div className="mt-4 flex justify-center gap-2">
          {children.map((_, i) => (
            <button
              ...
              className={`h-2 rounded-full transition ${i === index ? "w-6 bg-charcoal/70" : "w-2 bg-charcoal/40 hover:bg-charcoal/55"}`}
            />
          ))}
        </div>
      )}
