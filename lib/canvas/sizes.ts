...
const PRICES: Record<string, { priceGBP: number; priceUSD: number }> = {
  // ── Horizontal ──────────────────────────────────────────────────────────
  "10x8":  { priceGBP: 29.99,  priceUSD: 39.99  },
  "12x9":  { priceGBP: 34.99,  priceUSD: 49.99  },
  "14x11": { priceGBP: 39.99,  priceUSD: 54.99  },
  "16x12": { priceGBP: 44.99,  priceUSD: 59.99  },
  "18x12": { priceGBP: 49.99,  priceUSD: 69.99  },
  "20x10": { priceGBP: 49.99,  priceUSD: 69.99  },
  "20x16": { priceGBP: 54.99,  priceUSD: 74.99  },
  "24x16": { priceGBP: 59.99,  priceUSD: 79.99  },
  "24x18": { priceGBP: 64.99,  priceUSD: 89.99  },
  "24x20": { priceGBP: 69.99,  priceUSD: 94.99  },
  "30x15": { priceGBP: 74.99,  priceUSD: 99.99  },
  "30x20": { priceGBP: 74.99,  priceUSD: 99.99  },
  "30x24": { priceGBP: 84.99,  priceUSD: 114.99 },
  "32x24": { priceGBP: 84.99,  priceUSD: 114.99 },
  "36x12": { priceGBP: 79.99,  priceUSD: 109.99 },
  "36x24": { priceGBP: 89.99,  priceUSD: 119.99 },
  "40x20": { priceGBP: 99.99,  priceUSD: 134.99 },
  "40x30": { priceGBP: 119.99, priceUSD: 159.99 },
  "48x16": { priceGBP: 99.99,  priceUSD: 134.99 },
  "48x24": { priceGBP: 119.99, priceUSD: 159.99 },
  ...
  "10x20": { priceGBP: 49.99,  priceUSD: 69.99  },
  "11x14": { priceGBP: 39.99,  priceUSD: 54.99  },
  "12x16": { priceGBP: 44.99,  priceUSD: 59.99  },
  "12x18": { priceGBP: 49.99,  priceUSD: 69.99  },
  "12x36": { priceGBP: 79.99,  priceUSD: 109.99 },
  "15x30": { priceGBP: 74.99,  priceUSD: 99.99  },
  "16x20": { priceGBP: 54.99,  priceUSD: 74.99  },
  "16x24": { priceGBP: 59.99,  priceUSD: 79.99  },
  "16x48": { priceGBP: 99.99,  priceUSD: 134.99 },
  "18x24": { priceGBP: 64.99,  priceUSD: 89.99  },
  ...
  "12x12": { priceGBP: 39.99,  priceUSD: 54.99  },
  "14x14": { priceGBP: 44.99,  priceUSD: 59.99  },
  "16x16": { priceGBP: 49.99,  priceUSD: 69.99  },
  "20x20": { priceGBP: 69.99,  priceUSD: 94.99  },
  "24x24": { priceGBP: 89.99,  priceUSD: 119.99 },
  "30x30": { priceGBP: 109.99, priceUSD: 149.99 },
  "32x32": { priceGBP: 119.99, priceUSD: 159.99 },
  "36x36": { priceGBP: 159.99, priceUSD: 214.99 },
};
