  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "card":       "0 1px 3px rgba(45,41,38,0.04), 0 4px 12px rgba(45,41,38,0.05)",
        "card-hover": "0 2px 8px rgba(45,41,38,0.07), 0 12px 28px rgba(45,41,38,0.08)",
        "elevated":   "0 4px 16px rgba(45,41,38,0.08), 0 16px 48px rgba(45,41,38,0.07)",
        "subtle":     "0 1px 4px rgba(45,41,38,0.06)",
      },
    },
  },
  plugins: [],
